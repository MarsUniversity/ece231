...
\begin{enumerate}
\item Block 2 Skills review due next lesson
...
\item [Required]:
\begin{itemize}
\item  Textbook, sections 4.1--4.2, pages 155--172
\end{itemize}
\item [Optional]: None
\end{description}
...
\textbf{HOMEWORK}
\begin{description}
\item [Required textbook problems]: 4.3, 4.7a, 4.10a --- Due Lesson 17
\item [Recommended textbook problems]: 4.10b
\end{description}
