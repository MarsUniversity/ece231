...
\end{equation}
The closest standard resistance value to $499\ k\Omega$ is $470\ k\Omega$ which give an actual gain of
\begin{equation}
...
Design an Op Amp circuit that implments the block diagram shown in Figure \ref{fig: Example2}
\begin{figure} [h!]
\centering
...
Designs are nout unique.... We will do three designs that work in this example

\soln{3in}{
Start by writing an equation for the transfer characterisitic
\begin{equation}
