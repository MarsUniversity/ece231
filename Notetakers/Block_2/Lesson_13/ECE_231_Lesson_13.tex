...
\soln{5in}{
	...
	\begin{eqnarray}
		...
		V_x ( \frac{1}{100k} + \frac{V_x}{150k} + \frac{51}{R_F} ) = \frac{10}{100k} \\
	...
	\begin{eqnarray}
		V_x = \frac{10}{100k} \left( \frac{1}{100k} + \frac{1}{150k} + \frac{1}{R_F} \right) = \frac{10}{100k} \left( \frac{300k R_F}{5 R_F + 15.3M} \right) \\
